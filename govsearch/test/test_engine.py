...
class EngineTestCase(unittest.TestCase):
    ...
    def testEngine(self):
        ...
        client.add_document(doc_id="doc1", title="hello world", body="foo bar hello", foo = 1)
        client.add_document(doc_id="doc2", title="hello my world", body="foo bar helloz", foo = 2)
